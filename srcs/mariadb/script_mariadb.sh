...
CREATE USER IF NOT EXISTS '${MYSQL_ADMIN_NAME}'@'localhost' IDENTIFIED BY '${MYSQL_ROOT_PASSWORD}';
GRANT ALL PRIVILEGES ON ${MYSQL_DATABASE_NAME}.* TO '${MYSQL_ADMIN_NAME}'@'localhost';
